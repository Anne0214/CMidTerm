...
namespace Ado.Net.SqlDataLayer
{
    public class SqlParameterBuilder
    {
        ...
        public SqlParameterBuilder AddStringOut(string parameterName)
        {
            var parameter = new SqlParameter(parameterName, System.Data.SqlDbType.NVarChar) { Direction = ParameterDirection.Output };
            _parameters.Add(parameter);
